================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: UsbStrageKeybordLock プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した UsbStrageKeybordLock には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには UsbStrageKeybordLock アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

UsbStrageKeybordLock.vcxproj
...
UsbStrageKeybordLock.vcxproj.filters
...
UsbStrageKeybordLock.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   CUsbStrageKeybordLockApp アプリケーション クラスを宣言します。

UsbStrageKeybordLock.cpp
   これは、アプリケーション クラス CUsbStrageKeybordLockApp を含むメイン アプリケー
   ション ソース ファイルです。

UsbStrageKeybordLock.rc
...
res\UsbStrageKeybordLock.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル UsbStrageKeybordLock.rc に含まれていま
   す。

res\UsbStrageKeybordLock.rc2
...
UsbStrageKeybordLockDlg.h, UsbStrageKeybordLockDlg.cpp - ダイアログ
   これらのファイルは CUsbStrageKeybordLockDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な UsbStrageKeybordLock.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   UsbStrageKeybordLock.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
