========================================================================
 ダイナミック リンク ライブラリ: UsbStrageDisabler プロジェクトの概要
========================================================================

この UsbStrageDisabler DLL は、AppWizard により作成されました。

このファイルには、UsbStrageDisabler 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


UsbStrageDisabler.vcxproj
...
UsbStrageDisabler.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、UsbStrageDisabler.pch 
