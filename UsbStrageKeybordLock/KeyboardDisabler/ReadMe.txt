========================================================================
 ダイナミック リンク ライブラリ: KeyboardDisabler プロジェクトの概要
========================================================================

この KeyboardDisabler DLL は、AppWizard により作成されました。

このファイルには、KeyboardDisabler 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


KeyboardDisabler.vcxproj
...
KeyboardDisabler.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、KeyboardDisabler.pch 
